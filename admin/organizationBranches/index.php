...
$current_page = 'organizationBranches';
$menu_path = '../';

$conn = getConnection();
// Fetch all branches
$branches = $conn->query("SELECT * FROM organization_branches ORDER BY branch_name")->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Organization Branches - ZoCrew HRMS</title>
...
<body>
    ...
    <div class="main-content">
        <div class="page-header">
            ...
            <button class="add-btn" id="openModal"><i class="fas fa-plus"></i> Add Branch</button>
        </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= htmlspecialchars($branch['manager_contact']) ?></td>
                        <td class="actions">
                            <a href="#" title="Edit" onclick='editBranch(<?= json_encode($branch) ?>)'><i class="fas fa-edit"></i></a>
                            <a href="#" class="delete" title="Delete" onclick="deleteBranch(<?= $branch['branch_id'] ?>)"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php endforeach; else: ?>
                    <tr><td colspan="10">No branches found.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
    ...
    <div id="branchModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-title">
                ...
                <span id="modalTitle">Add Branch</span>
            </div>
            <form method="post" action="save.php" id="branchForm">
                <input type="hidden" name="branch_id" id="branch_id">
                <label for="branch_name">Branch Name *</label>
                <input type="text" id="branch_name" name="branch_name" required maxlength="255">
                <label for="address">Address</label>
                <textarea id="address" name="address" rows="2" maxlength="255"></textarea>
                ...
                <input type="text" id="manager_name" name="manager_name" maxlength="100">
                <label for="manager_contact">Manager Contact</label>
                <input type="text" id="manager_contact" name="manager_contact" maxlength="20">
    ...
    function editBranch(branch) {
        ...
        document.getElementById('country').value = branch.country || '';
        document.getElementById('contact_number').value = branch.contact_number || '';
        document.getElementById('manager_name').value = branch.manager_name || '';
        document.getElementById('manager_contact').value = branch.manager_contact || '';
        document.getElementById('branchModal').style.display = 'block';
    }
    // Delete branch
