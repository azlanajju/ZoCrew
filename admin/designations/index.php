...
$conn = getConnection();
$designations = $conn->query("SELECT designation_id, name, description FROM designations ORDER BY name")->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Designations - ZoCrew HRMS</title>
...
<body>
    ...
    <div class="main-content">
        <div class="page-header">
            <h1>Designations</h1>
            <button class="add-btn" id="openModal"><i class="fas fa-plus"></i> Add Designation</button>
        </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= htmlspecialchars($designation['description']) ?></td>
                        <td class="actions">
    ...
    <div id="addModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-title"><i class="fas fa-plus-circle" style="color:var(--primary-color);margin-right:8px;"></i>Add Designation</div>
            <form method="post" action="add.php" autocomplete="off">
                <label for="designation_name">Designation Name *</label>
                <input type="text" id="designation_name" name="designation_name" required maxlength="100">
                <label for="designation_desc">Description</label>
                <textarea id="designation_desc" name="designation_desc" rows="3" maxlength="255"></textarea>
