...
$conn = getConnection();
$departments = $conn->query("SELECT department_id, name, description FROM departments ORDER BY name")->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Departments - ZoCrew HRMS</title>
...
<body>
    ...
    <div class="main-content">
        <div class="page-header">
            <h1>Departments</h1>
            <button class="add-btn" id="openModal"><i class="fas fa-plus"></i> Add Department</button>
        </div>
    ...
    <div id="addModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-title"><i class="fas fa-plus-circle" style="color:var(--primary-color);margin-right:8px;"></i>Add Department</div>
            <form method="post" action="add.php" autocomplete="off">
                <label for="dept_name">Department Name *</label>
                <input type="text" id="dept_name" name="dept_name" required maxlength="100">
                <label for="dept_desc">Description</label>
                <textarea id="dept_desc" name="dept_desc" rows="3" maxlength="255"></textarea>
